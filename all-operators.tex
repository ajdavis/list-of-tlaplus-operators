...
\begin{tabular}{ |c|c|c }
\@x{ \.{\land} } &
\@y{ /$\backslash$ or $\backslash$land } &
and \\

\@x{ \.{\lor} } &
\@y{ $\backslash$/ or $\backslash$lor } &
or \\

\@x{ {\lnot} } &
\@y{ $\sim$ or $\backslash$lnot or $\backslash$neg } &
not \\
...
\@x{ {\langle}x, y{\rangle}} &
\@y{ \textless\textless x, y\textgreater\textgreater } &
a tuple containing some x, y \\
...
\@x{ \.{\equiv}} &
\@y{ $\textless$=$\textgreater$ or $\backslash$equiv } &
is equivalent to \\
...
\@x{ \.{\subseteq}} &
\@y{ $\backslash$subseteq } &
subset or equal \\

\@x{ \.{\sqsubset}} &
\@y{ $\backslash$sqsubset } &
is a refinement \\

\@x{ \.{\sqsubseteq}} &
\@y{ $\backslash$sqsubseteq } &
is a refinement or equal \\
...
\@x{ \.{\cap} } &
\@y{ $\backslash$cap or $\backslash$intersect } &
intersection \\
...
\@x{ \.{\oplus} } &
\@y{ (+) or $\backslash$oplus } &
 \\

\@x{ \.{\ominus} } &
\@y{ (-) or $\backslash$ominus } &
 \\
...
\@x{ \.{\otimes} } &
\@y{ ($\backslash$X) $\backslash$otimes } &
 \\

\@x{ \.{\oslash} } &
\@y{ (/) or $\backslash$oslash } &
 \\
...
\@x{ {\WF}_{ v}} &
\@y{ WF\_v } &
weak fairness variables \\

\@x{ {\SF}_{ v}} &
\@y{ SF\_v } &
strong fairness variables \\

\@x{ \.{\supseteq}} &
\@y{ $\backslash$supseteq } &
superset \\
...
\@x{ \.{\sqsupset}} &
\@y{ $\backslash$sqsupset } &
 \\

\@x{ \.{\sqsupseteq}} &
\@y{ $\backslash$sqsupseteq } &
 \\
...
\@x{ \.{\leftarrow}} &
\@y{ \textless- } &
bind module instance variable? \\

\@x{ \.{\cup}} &
\@y{ $\backslash$cup or $\backslash$union } &
union \\
...
\@x{ \.{\times} } &
\@y{ $\backslash$X or $\backslash$times } &
multiply \\
...
\@x{ {\Box}} &
\@y{ [] } &
always in the future/henceforth \\

\@x{ {\Diamond}} &
\@y{ \textless\textgreater } &
sometime(s) in the future/eventually  \\
...
\@x{ \.{\whileop}} &
\@y{ -+-\textgreater } &
leads to in one step? \\

\@x{ \.{\mapsto}} &
\@y{ \textbar-\textgreater } &
struct field maps to \\
...
\@x{ \.{\circ} } &
\@y{ $\backslash$o or $\backslash$circ } &
...
\@x{ x \.{\mbox{}^+}} &
\@y{ x\^{}+ } &
BNF grammar: at least one x \\

\@x{ x \.{\mbox{}^*}} &
\@y{ x\^{}* } &
BNF grammar: any number of x's \\
